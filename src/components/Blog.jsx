            ...
            <div class="bg-white py-24 sm:py-32">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:mx-0">
                        <h2 class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl animate__animated animate__bounceIn animate__slow animate__infinite">From the blog</h2>
                    ...
                    <div class="mx-auto  grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        {/* article 1 */}
                        <article class="flex max-w-xl flex-col items-start justify-between bg-gradient-to-r from-[#525252] to-[#3d72b4] p-5 rounded-lg animate__animated animate__flipInY animate__slow">
                            ...
                            <div class="group relative">
                                ...
                                <p class="mt-5 line-clamp-3 text-sm/6 bg-gradient-to-r from-[#9F6976] via-[#d693db] to-[#F3D7CA]  text-transparent bg-clip-text">The Grand Egyptian Museum has been in the works for over two decades. Construction ground to a halt during the Arab Spring a decade ago but the museum, which is set to fully open in the coming months, will be the largest archeological complex in the world, housing some of Egypt’s greatest treasures.</p>
                            </div>
                        ...
                        {/* article 2 */}
                        <article class="flex max-w-xl flex-col items-start justify-between bg-gradient-to-r from-[#525252] to-[#3d72b4] p-5 rounded-lg animate__zoomInDown animate__animated">
                            <div class="flex items-center gap-x-4 text-xs">
                        ...
                        <article class="flex max-w-xl flex-col items-start justify-between bg-gradient-to-r from-[#525252] to-[#3d72b4] p-5 rounded-lg">
                            ...
                            <div class="group relative">
                                ...
                                <p class="mt-5 line-clamp-3 text-sm/6 bg-gradient-to-r from-[#9F6976] via-[#d693db] to-[#F3D7CA] inline-block text-transparent bg-clip-text">Ancient Egyptians during the third and fourth dynasties perfected the construction of pyramids as burial chambers for their kings.</p>
                            </div>
                            <div class="relative mt-8 flex items-center gap-x-4">
